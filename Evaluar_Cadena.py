...
def Verifica_Cadena(estado_Inicio,cadena_A_Evaluar, lista_Estados,lista_General_Transiciones, lista_Estados_Aceptacion):
...
def Verifica_Cadena_Retorna(estado_Inicio,cadena_A_Evaluar, lista_Estados,lista_General_Transiciones, lista_Estados_Aceptacion):
    inicio = estado_Inicio
    actual = inicio
    Cadena_Evaluada = ""
    ...
    if actual in lista_Estados_Aceptacion:
        Cadena_Evaluada = cadena_A_Evaluar+" CORRECTA"
        print("---CADENA CORRECTA---")
    else:
        Cadena_Evaluada = cadena_A_Evaluar+" INCORRECTA"
        print("---CADENA INCORRECTA")
    

    return Cadena_Evaluada
